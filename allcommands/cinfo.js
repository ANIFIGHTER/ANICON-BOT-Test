...
const ping = {
    ...
    async execute(interaction) {
        ...
        for (let i = 0; i <cards.length; i++){
            ...
            console.log(Object.getOwnPropertyNames(cardnamelist))
    for (let x =0;x<=Object.getOwnPropertyNames(cardnamelist).length;x++){
        ...
        details.setAuthor(interaction.user.tag, interaction.user.avatarURL());
        ...
        details.setFooter(`${card.quote}`, 'https://static.zerochan.net/Nakajima.Atsushi.%28Bungou.Stray.Dogs%29.full.2028610.jpg')
