        ...
        con.query(sql, async function vroom (err,data) {
            if (data.length === 0) {await interaction.reply('You are not registered. Register using \'/start\'')}
                ...
                con.query(cardsinteam,[user_id],async function(err,data){
                    ...
                    teamembeds[0].setAuthor(interaction.user.tag, interaction.user.avatarURL())
                    ...
                    teamembeds[i+1].setAuthor(interaction.user.tag, interaction.user.avatarURL());
                    ...
                    teamembeds[i+1].setFooter('WILL THINK OF SOMETHING')    
